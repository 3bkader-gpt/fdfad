...
export default async function AdminProductsPage() {
  ...
  // Safe cast since we know the table schema
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-1 text-left">
              <h3 className="line-clamp-1 text-left text-sm font-medium tracking-tight uppercase">
                {product.title}
              </h3>
              <p className="text-left text-lg font-bold text-[#C89B7E]">{product.price} EGP</p>
