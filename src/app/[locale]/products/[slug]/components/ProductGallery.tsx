      ...
      <div className="bg-bg-elevated border-border-color relative aspect-[3/4] w-full overflow-hidden border-b md:rounded-2xl md:border">
        {images.length > 0 ? (
          <>
            ...
            {/* Cover/Action Badge */}
            {madeInEgypt && (
              <span className="bg-brand-primary absolute bottom-6 left-6 rounded px-4 py-1.5 text-[9px] font-bold tracking-[0.2em] text-white dark:text-bg-main uppercase shadow-lg backdrop-blur-sm">
                {tc('madeInCairo')}
              </span>
            )}
