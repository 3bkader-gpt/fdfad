  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center px-6 pt-12 text-center">
      ...
      <p className="mb-10 text-sm text-pretty opacity-60">
        Your curated items have been reserved. We will prepare your hand-packed order immediately.
      </p>
      ...
      <footer className="mt-16 opacity-30">
        <p className="text-[9px] font-bold tracking-widest uppercase">© 2026 FADFAAD CAIRO</p>
      </footer>
    </div>
  );
}
